...
class AddCouponViewTest(TestCase):
    ...
    def test_add_valid_coupon(self):
        ...
        # Add the coupon
        response = self.client.post(reverse("add_coupon"), {"code": "test"})
...
class CheckoutViewTest(TestCase):
    ...
    def test_empty_cart(self):
        ...
        messages = list(get_messages(response.wsgi_request))
        self.assertEqual(str(messages[0]), "There's nothing in your cart at the moment")
...
class CheckoutSuccessViewTest(TestCase):
    ...
    def setUp(self):
        ...
        # Setup Order
        self.order = Order.objects.create(order_number="12345", email="test@test.com")
